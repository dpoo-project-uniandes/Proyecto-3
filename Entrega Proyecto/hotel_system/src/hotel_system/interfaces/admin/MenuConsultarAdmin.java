...
public class MenuConsultarAdmin extends JPanel{
	...
	private Input rangoHorario;



	public MenuConsultarAdmin(
			String user,
		...
		private void configNewBookingButton() {
			...
			this.createProductBtn.addActionListener(new ActionListener() {
				@Override
